...
| **INSIGHT lane (342 ready, 343 backfill done)** | `342-INSIGHT-data-driven-ranking-auto-publish.md`, `343-INSIGHT-007-data-population-audit-and-backfill.md` | 343 = INSIGHT-007 backfill chain LIVE + 2026 シーズン全試合 backfill (3/27-5/13、227 game) 完了。production DB games 11→227 / batting_logs 198→4086 / players 21→39 / advanced_metric_snapshots 122→616 / season scope 新規充足。status `PHASE_3_BACKFILL_DONE_READY_FOR_CLOSE`、close 候補。342 = 343 で prerequisite 解消、status `READY_FOR_PHASE_1_IMPL`、初版 A1 月次 OPS / E1 直近 hot/cold は data 揃い、user GO で impl 着手可能。「12 球団 top 30」は player roster 偏り(g=28、f/h/l=0)のため別 ticket 必要。GH Issue #21(342) + #23(343)。 |
