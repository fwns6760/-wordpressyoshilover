...
| **quality short player event title** | `369-QA-short-player-event-title-quality.md` | 68539 / 68608 型。`浦田俊輔、発言` / `浦田俊輔、安打` のような短すぎる `選手名 + 薄いイベント語` title を、同じX source本文内の literal な `2回適時打` / `3安打1打点猛打賞` 等で補強する。GitHub Issue #38。 |
