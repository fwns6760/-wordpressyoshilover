...
| **#95 / 417 ヨシラバー X-post branding 2 source mix + 試合中 15 分 schedule (DONE 2026-05-22、 close 候補)** | GH Issue #95 / `doc/active/417-X-POST-MAIL-HOCHI-PRIORITY-PIGGYBACK.md` | 4 scope 全完了: (1) Source A voice 統一 (ヨシラバー voice 180-280 字、 commit `9cc08b1` / image `yoshilover-voice-9cc08b1`)、 (2) Source B 維持 (418 case B format、 commit `6ab949f`)、 (3) schedule (`x-post-mail-flush 0 6-22 *` + `flush-game-1 15,30,45 19-20 *` + `flush-game-2 15,30 21 *`)、 (4) Tavily 0 化 (旧 5 cron PAUSE + 5/17 one-time cron DELETE、 log verify 0 hit 6:00 UTC 以降)。 user 承認後 close。 |
