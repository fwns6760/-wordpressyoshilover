...
| `doc/active/380-x-post-mail-player-diversity-cap.md` (GH #54) | REVIEW_NEEDED | 2026-05-18 07:00 JST の X 投稿候補 mail 8 件で `マルティネス` 3 件 / `岸田 行倫` 2 件を Gmail message id `19e37f4bb23efcbb` で確認。07:00 mail log は GCS DB `latest_game_date=2026-05-17 staleness_days=1 max=2`、production GCS object は `2026-05-18T01:01:30Z` 更新。repo-local DB は stale (`latest_game_date=2026-05-13`) だが production source of truth ではない。repo 実装: same-player cap default 2、next Giants row fallback、source title / URL / summary / roster alias 検出付き news/opinion fallback、mixed label `巨人Xポスト案`。py_compile PASS、pytest/unittest `tests.test_x_post_mail` 89 passed。未 deploy、Scheduler / env / Secret / WP / X / SNS / production DB は未変更。 |
