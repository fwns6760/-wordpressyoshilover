...
| `364-QA-cross-family-same-event-dedup` | READY | GitHub Issue #33。報知 / スポニチ / デイリー等が同じ巨人ニュースを別タイトルで出す穴を扱う。既存 319/339/334/363 では残る 2媒体以上の同一選手・同一出来事を `event_key` で止める ticket。実装・deploy は未実行 |
