...
| `374-x-post-mail-dedup-starvation-fallback` | REVIEW_NEEDED | GitHub Issue #43。353〜355 の手動確認 mail が 24h dedup ledger を埋め、15:00 は 1 件、17:30 は 0 件で自然 mail が枯れた問題を修正。dedup は維持しつつ、dedup 後候補が default 3 件未満なら dedup-safe 候補を先頭に残して dedup なし候補で backfill。py_compile / compileall / AST PASS、x-post-mail 関連 pytest 107 passed。Scheduler / env / Secret / WP / X / SNS は未変更、追加 mail 回避のため手動 execute は未実行予定 |
