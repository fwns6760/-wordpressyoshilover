...
_LIVE_VOICE_NOTE = (
    ...
    "⑦【最優先の型】入力にレギュラー争い・起用競合の文脈 (2人の選手が"
    "同じポジション・役割を争う場面) があれば、争点+自分の立場型で書く"
    " (競合2人を実名で並べ、争いがチームに何をもたらすかを1つ、"
    "どっち派か立場を置く。「どっちで見たいか割れそうだけど、今は◯◯が"
    "勝ってると思う」の形)。2026-07-16 実測で最も反応が付いた型。"
    "立場は断定しすぎず、読者が反対側に立てる余白を残す。"
)
                    ...
                    txt = (
                        _bgen.build_quote_rt_comment(
                            ...
                            extra_voice_note=(
                                ...
                                "https://yoshilover.com/data/notable/ 。毎試合更新、観戦前の10秒"
