...
TRUSTED_SOURCE_PROFILES = (
    ...
    SourceProfile(
        family="baseball_channel",
        trust="secondary",
        family_trust="mid",
        domains=("baseballchannel.jp",),
    ),
    SourceProfile(
        family="full_count",
        trust="secondary",
        family_trust="mid",
        domains=("full-count.jp",),
    ),
    SourceProfile(
        family="ntv_news",
        trust="secondary",
        family_trust="mid",
        domains=("news.ntv.co.jp",),
    ),
    SourceProfile(
        family="asahi",
        trust="secondary",
        family_trust="mid",
        domains=("asahi.com", "digital.asahi.com"),
    ),
    SourceProfile(
        family="mainichi",
        trust="secondary",
    ...
    SourceProfile(
        family="weekly_baseball",
        trust="secondary",
        family_trust="mid",
        domains=("baseball.findfriends.jp",),
    ),
    SourceProfile(
        family="friday",
        trust="secondary",
        family_trust="mid",
        domains=("friday.kodansha.co.jp",),
    ),
    SourceProfile(
        family="smart_flash",
        trust="secondary",
        family_trust="mid",
        domains=("smart-flash.jp",),
    ),
    SourceProfile(
        family="jprime",
        trust="secondary",
    ...
    SourceProfile(
        family="news_postseven",
        trust="secondary",
        family_trust="mid",
        domains=("news-postseven.com",),
    ),
    SourceProfile(
        family="daily_shincho",
        trust="secondary",
        family_trust="mid",
        domains=("dailyshincho.jp",),
    ),
    SourceProfile(
        family="gendai_media",
        trust="secondary",
        family_trust="mid",
        domains=("gendai.media",),
    ),
    SourceProfile(
        family="asagei",
        trust="secondary",
    ...
    SourceProfile(
        ...
        trust="secondary",
        family_trust="mid",
        domains=("chunichi.co.jp", "www.chunichi.co.jp"),
    ),
)
