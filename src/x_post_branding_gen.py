...
- **次の無難ワードで逃げるの禁止 (理由のない持ち上げ = 一番ダメ)**:
  ...
  「持ってる選手」「持っているとしか言いようがない」「経験値が全て」「本物だ」「新しい風が吹く」
- **応援団の掛け声で締めるの禁止**: 「繋いでいこう」「盛り上げていこう」「応援していこう」
  「頑張っていこう」 等の一人称複数の cheerleader 締めにしない (一ファンの読みで終える)
- **同意を求めるだけの締めも禁止**: 「〜してくれて本当によかったと思わない?」 のような
  ぬるい同意誘導で終えない (問いかけるなら「次もこの形で行くのか?」 等、 論点のある問いにする)
...
_VOICE_YUTOUSEI_ENDING = _re.compile(
    ...
    # casual な終助詞 (わ/よ/ね/な/ぞ) を末尾に付けても優等生締めは弾く
    # (例: 「期待してるわ。」「楽しみだな。」)
    r"[わよねなぞ。!！？\?…\s]*$"
)
...
_VOICE_HOPIUM_MARKERS = _re.compile(
    ...
    # 2026-06-04 追い込み: 「持っているとしか言いようがない」 系の blanket 持ち上げ、
    # 「繋いでいこう / 盛り上げていこう」 系の一人称複数の応援団 (cheerleader) 締め
    r"持っ(て|てい)るとしか|"
    r"(繋いで|つないで|盛り上げて|応援して|頑張って|戦って|乗り越えて|勝ち進んで|勝ち上がって|勝ち取ろう)(いこう|いきたい|いきましょう|いくぞ|いくしかない))"
)
